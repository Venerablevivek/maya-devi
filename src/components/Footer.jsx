...
const Footer = () => {
  return (
    <div className=' relative ' >
        <section className="py-5 bg-[#249138] sm:pt-16 lg:pt-16">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img className="w-auto" src={MayaLogo} alt="" />

                <p className="text-base leading-relaxed text-gray-100 mt-7">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-[#23376c] uppercase">Company</p>
        ...
        <p className="text-sm text-center text-gray-200">© Copyright 2024, All Rights Reserved by Maya Devi</p>
    </div>
</section>
