...
const BachelorHotelManagement = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of  Hotel Management (BHM) </h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >The Bachelor of Hotel Management (BHM) is an extensive four-year undergraduate program aimed at equipping students for fulfilling careers in the hospitality sector. Bachelor of Hotel Management (BHM) programs offer students a robust grounding in multiple facets of hotel management, covering operations, administration, marketing, finance, and human resources. During their BHM studies, students acquire both hands-on skills and theoretical insights crucial for excelling in the hospitality industry. They delve into topics such as hospitality management principles, food and beverage operations, accommodation management, event coordination, and customer service.</p>
                    <Link to="/apply-now" >
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4 font-semibold ">Bachelor</td>
...
export default BachelorHotelManagement