...
const MastersHotelManagement = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Master of Hotel Management</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >The Masters of Hotel Management program is tailored to empower students with advanced expertise required for managerial roles in the hospitality sector. Combining academic depth with hands-on experience, it covers specialized topics including hotel operations, revenue management, strategic planning, and guest relations. Emphasizing critical thinking and decision-making skills, the program equips graduates to effectively navigate the dynamic global hospitality industry. With internships, industry projects, and networking opportunities, students emerge ready to excel in leadership positions across hotels, resorts, restaurants, and related hospitality ventures.</p>
                    <Link to="/apply-now" >
...
export default MastersHotelManagement