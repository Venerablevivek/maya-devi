...
const BtechCloud = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of Technology in Cloud Computing</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >A Bachelor of Technology (B.Tech.) in Cloud Computing is an undergraduate program that specializes in the principles, technologies, and practices related to cloud computing. Cloud computing involves the delivery of various computing services over the internet, including storage, servers, databases, networking, software, and more, providing users with on-demand access to scalable resources. Graduates with a B.Tech. in Cloud Computing are well-equipped to pursue careers as cloud architects, cloud engineers, cloud administrators and solution architects in various industries. They may find employment opportunities in cloud service providers, technology companies, enterprises, consulting firms and government organizations.
<br/><br/>
Given the increasing adoption of cloud technologies across industries, professionals with expertise in cloud computing are in high demand. Obtaining relevant certifications from cloud providers such as Amazon Web Services (AWS), Microsoft Azure, or Google Cloud Platform (GCP) can further enhance career prospects for graduates in this field.</p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Intermediate / 10+2 or its equivalent examination with PCM (Physics, Chemistry, Maths) from a recognized Board/ University/ MDU Entrance Examinationase of candidate belonging to reserved category.</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Cloud Computing</td>
