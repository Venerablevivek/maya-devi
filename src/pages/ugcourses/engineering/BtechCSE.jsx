...
const BtechCSE = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of Technology in Computer Science Engineering</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >At our esteemed department, we pride ourselves on fostering innovation, creativity, and excellence in the ever-evolving fields of computer science and engineering. The Department is currently running a B.Tech.  in Computer Science and  Engineering , AI and ML, Cyber Security, Cloud Computing, Data Science and an M.Tech.   in AI and ML , Data Science. We offer a comprehensive range of academic programs designed to prepare students for successful careers in computing and engineering. Whether you’re an undergraduate seeking to dive into the fundamentals or a graduate student pursuing advanced research opportunities, our programs provide a solid foundation in theory and hands-on experience in cutting-edge technologies.</p>
                    <Link to="/apply-now" >
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Computer Science & Engineering</td>
