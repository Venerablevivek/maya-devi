...
const MtechDataScience = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Master of Technology in Data Science</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >M.Tech. (Master of Technology) in Data Science is a postgraduate degree program that focuses on advanced concepts, techniques, and technologies related to data science. This course covers techniques for extracting valuable insights and patterns from large datasets. Also the course focuses on technologies and platforms for processing and analysing massive datasets. Students learn about distributed computing frameworks such as Hadoop and Spark, as well as tools for data storage, retrieval, and processing. M.Tech. in Data Science include a research component, this may involve identifying research problems, designing experiments, collecting and analysing data, and presenting findings in a thesis or research paper.</p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Merit prepared on basis of B.Tech.(Mechanical/Electrical/Electronic Engg)/MCA/M.Sc/MDU Entrance examination</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Data Science</td>
