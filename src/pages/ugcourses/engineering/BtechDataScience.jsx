...
const BtechDataScience = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of Technology in Data science and Engineering</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >A Bachelor of Technology (B.Tech.) in Data Science is an undergraduate program that focuses on the interdisciplinary field of data science, which combines aspects of computer science, statistics, and domain-specific knowledge to extract insights and knowledge from data.
<br/>
Graduates with a B.Tech. in Data Science are well-equipped to pursue careers in a wide range of industries, including finance, healthcare, e-commerce, marketing, telecommunications, and more. They may work as data scientists, data analysts, machine learning engineers, business analysts, or consultants, among other roles.
<br/>
Given the increasing importance of data-driven decision-making in today’s world, graduates with expertise in data science are in high demand across various sectors. Additionally, some graduates may choose to pursue further education through master’s or doctoral programs to deepen their knowledge and specialize in specific areas of data science.</p>
                    <Link to="/apply-now" >
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Data Science Engineering</td>
...
export default BtechDataScience