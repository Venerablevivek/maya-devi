...
const BtechMechatronics = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of Technology in Mechatronics and Robotics
</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >Department of Mechanical Engineering offers Bachelor of Technology (B.Tech) degree in Mechatronics and Robotics. It is an interdisciplinary program that combines elements of mechanical engineering, electrical engineering, computer science engineering, and control systems. Students in this program learn to design, develop, and implement intelligent systems that integrate mechanical components with electronics, sensors, actuators, and software to create automated and robotic systems. The program emphasizes integrating mechanical systems with electronics, software, and control systems to create intelligent and automated systems. Students work on mechatronics projects involving sensors, actuators, microcontrollers, PLCs, motors, and HMI (Human-Machine Interface) systems. Mechatronics and robotics are fascinating fields that blend principles from mechanical engineering, electrical engineering, computer science, and control engineering to design and create intelligent systems and machines.
                    </p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Merit prepared on basis of 10+2 PCM/B.Sc(PCM)/Diploma in Mechanical/Electrical, Electronics Engg</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Mechatronics and Robotics</td>
...
export default BtechMechatronics