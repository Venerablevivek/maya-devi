...
const MtechThermal = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>M.Tech (Master of Technology) in Thermal Engineering</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >M.Tech. in Thermal Engineering is offered by Department of Mechanical Engineering at MDU (Maya Devi University) campus. Specialization offers Deep Learning in CFD (Computational Fluid dynamics), Heat transfer, Fluid Flow, IC Engines and Thermal Power plants. It helps in Designing and analyzing thermal system across power generation, cryogenic engines, refrigeration, air conditioning and Heat exchangers. It plays a crucial role in various industries where heat and energy management are essential, such as power generation, HVAC (Heating, Ventilation, and Air Conditioning), automotive engineering, aerospace, manufacturing, and renewable energy sectors. Department has the Researchers working at nano scale, in the traditional fields of Refrigeration, air conditioning and Heat Transfer. Students can expect to work on the most Traditional Problems.
                    </p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Merit prepared on basis of B.Tech.(Mechanical/Automobile/Industrial/Manufacturing Engg.)/MCA/M.Sc</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Thermal Engineering</td>
