...
const MtechEV = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Master of Technology in Electric Vehicle  Engineering
</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >M.Tech in Electric Vehicle Technology is offered by Department of Mechanical Engineering at MDU (Maya Devi University) campus. With the growing prices in fuel, electric vehicles are becoming more popular. Specialization focuses on fundamental principles and comprehensive understanding of electric vehicle technology, including design, development and application of electric vehicles. Program focuses on development and application of related technologies such as fuel cells, batteries and hybrid electric vehicles. Students will learn about principles of electric vehicle design, motor design, and control system and power electronics. Additionally, they will explore the regulations and policies related to electric vehicle technology, as well as the impact of electric vehicle technology on the environment.
                    </p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Merit prepared on basis of B.Tech.(Mechanical/Electrical/Electronic Engg)/MCA/M.Sc</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Electric Vehicle Technology</td>
