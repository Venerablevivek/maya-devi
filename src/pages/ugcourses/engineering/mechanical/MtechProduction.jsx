...
const MtechProduction = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>M.Tech (Master of Technology) in Production engineering</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >School of Engineering is running a two year full time post graduate program in Production engineering. The program aims at providing a valuable resource not only to the industries but also the society through excellence in technical education and research. Production Engineering is based on core industrial engineering and mechanical engineering skills, adding important elements from mechatronics, commerce, economics, and business management. This field also deals with the integration of different facilities and systems for producing quality products (with optimal expenditure) by applying the principles of physics and the results of manufacturing systems studies. The labs and workshops are equipped with machines like CNC lathes, welding machines which are now more in line with the industrial needs. With rich hardware and software resources and collaborative projects with the academia and industries, the department aims at providing an elite workforce of future leaders in myriad areas like manufacturing, designing and quality management.
                    </p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Merit prepared on basis of B.Tech.(Mechanical/Production/Industrial Engg./ Manufacturing)/MCA/MSc/</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Production Engineering</td>
...
export default MtechProduction