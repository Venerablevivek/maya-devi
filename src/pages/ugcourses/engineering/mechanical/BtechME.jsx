...
const BtechME = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        ...
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Bachelor of Technology in Mechanical Engineering
</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >Mechanical Engineering is a diverse and foundational branch of engineering that deals with the design, analysis, manufacturing, and maintenance of mechanical systems. Mechanical engineering is built upon principles of physics, mathematics, and material science. Understanding how forces, energy, and materials interact is fundamental to designing and optimizing mechanical systems. The design components and systems ranging from small individual parts to large-scale machinery like engines, turbines, and vehicles. They use computer-aided design (CAD) software and simulation tools to model and analyze the performance of these designs under various conditions.
<br/><br/>
Mechanical Engineering department plays a crucial role in shaping the future of technology and industry by combining creativity, analytical skills, and a deep understanding of physical principles.
                    </p>
                    <Link to="/apply-now" >
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Mechanical Engineering</td>
