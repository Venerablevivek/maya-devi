...
const MtechTransportation = () => {
  return (
    <div className='  w-full relative font-poppins ' >
        <div className=' w-10/12 mx-auto mt-[100px] md:mt-[150px] flex flex-col gap-5 md:gap-5 ' >
        <h2 className={` mb-4 text-2xl md:text-6xl tracking-tight font-bold text-center  `}>Master of Technology in Transportation Engineering</h2>
        <div className=' w-[20%] mx-auto h-[6px] bg-[#23376c] mt-[-10px] md:mt-[-20px] ' ></div>
            <div className=' flex flex-col md:flex-row gap-8 mb-10 md:gap-[80px] mt-5 justify-center md:justify-between ' >
                ...
                <div className=' flex flex-col gap-4 ' >
                    ...
                    <p className=' text-justify md:text-lg ' >Transportation Engineering involves planning, constructing and operating the transportation facilities for different modes of transport i.e., highways, railways, air transport, sea transport, and pipelines. Devising the urban & intermodal transportation in an environment-friendly manner is the prime goal of transportation engineering.
                    <br/>
                    <br/>
                    Transportation Engineering can be broadly classified into:
                    <ul className=' list-disc ' >
                    <li>Highway Engineering</li>
                    <li>Railroad Engineering</li>
                    <li>Port & Harbour Engineering</li>
                    <li>Airport Engineering</li>
                    <li>Urban Engineering</li>
                    </ul>
                    The curriculum of M. Tech in Transportation Engineering encompasses topics like Advanced Traffic Engineering, Advanced Railway Engineering, Urban Transport Planning, Ground Improvement Techniques, Airport Planning & Design, Highway Construction, Quality Control & Maintenance, etc.
                    </p>
                    <Link to="/apply-now" >
            ...
            <div className=' flex flex-col gap-10 mt-5 mb-[50px] ' >
               <div className=' flex flex-col gap-2 ' >
                        ...
                        <p>Bachelor degree in Civil Engineering/Technology or equivalent or a Master degree in Science/MDU Entrance examination recognized Board/ University/ MDU Entrance Examination</p>
                    </div>
                    </div>
                ...
                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <td className="whitespace-nowrap  px-6 py-4">Transportation Engineering</td>
...
export default MtechTransportation